...
my_SIR_model_2D = Forecasting_Model.my_SIR_model_2D
...
def forecastTwoQoI(firstT_initial, firstQoI_initial, secondT_initial, secondQoI_initial, T_final, QoI_final, pred_q_linspace=None, l1=None, l2=None):
    ...
    q_final = (q_mat_final[:, T0 + T_final - 1] - q_mat_final[:, T0 - 1])/T_final # "Observed" data at final time; use to evaluate predictions
...
# Forecasts from single-QoI inversions
...
# Forecasts from two-QoI inversions
forecastTwoQoI(firstT_initial = 30, firstQoI_initial = "s", secondT_initial= 30, secondQoI_initial = "i", T_final = 60, QoI_final = "s",
                pred_q_linspace = np.linspace(-0.005, 0.02, 5000), l1 = -0.00124319,  l2 = 0.01673326)
forecastTwoQoI(firstT_initial = 30, firstQoI_initial = "s", secondT_initial= 30, secondQoI_initial = "i", T_final = 60, QoI_final = "i",
                pred_q_linspace = np.linspace(-0.001, 0.005, 5000), l1 = -0.00037495,  l2 = 0.01684886)
forecastTwoQoI(firstT_initial = 30, firstQoI_initial = "s", secondT_initial= 31, secondQoI_initial = "s", T_final = 60, QoI_final = "s",
                pred_q_linspace = np.linspace(-0.003, 0.02, 5000), l1 = -0.00101035,  l2 = 0.01674927)
forecastTwoQoI(firstT_initial = 30, firstQoI_initial = "s", secondT_initial= 31, secondQoI_initial = "s", T_final = 60, QoI_final = "i",
                pred_q_linspace = np.linspace(-0.001, 0.006, 5000), l1 = -0.0004467,  l2 = 0.00278554)